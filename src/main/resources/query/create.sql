...
(
    `customer_board_number`      INT(5)        NOT NULL ,
...
(
    ...
    `inquiry_reply_date`    DATE         NOT NULL ,
...
(
    ...
    `store_id`        varchar(25) NOT NULL ,
    `live_titile`     varchar(20) NOT NULL ,
...
(
    `live_number`       INTEGER        NOT NULL    AUTO_INCREMENT,
